...
With the addition of newly produced sequencing data of two species of monogeneans, the aim of this study is to further improve already existing sequencing data and, with the addition of openly accessible data from NCBI Genbank shed more light onto the controversely discussed phylogeny of the neodermata with a focus on the positioning of the monogenenans.
