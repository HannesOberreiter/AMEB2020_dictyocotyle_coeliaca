...
The cause why our minION reads did not improve the quality of the Illumina reads could not be identified but was probably a high fragmentation of the DNA while library preparation of the reads, as the DNA assessment after extraction did look good, see fig. \@ref(fig:tapestation). These resulted in very short and also low coverage of these reads and no advantage for the Illumina assembly was gained by if the ONP reads were used in assembly and scaffolding.

The resulting tree does not correspond to the currently proposed hypotheses of the major parasitic groups, see figure \@ref(fig:trees). The sublcass of Monopisthocotyleans as basal group indicates a single evolutionary event which did split a simple life cycle as seen by most Monopisthocotyleans to more complex life cycles with multiple hosts as seen in Trematoda and Cestoda. The Polyopisthocotyleans seems to have undergone a second evolutionary step were they lost the trait of the complex life cycle and came back to a simple one. 

The same, as for life-cycle, can be said for lifestyle (ecto- vs. endoparasitism). We see that the basal group of Monopisthocotyleans is mainly ectoparasitic. As the Tubellaria, which can be seen as a close related sister group inside the Platyhelminthes to the Nermatoda, are free living we would expect that the ectoparasitic is the logical plesiomorphic trait. @Park2007 came to a similar conclusion that ectoparasitism arose first but only one Monogenea taxa (*M. sebastis*) was used in this study. 

ectoparasitism vs. endoparasit- ism) arose first within the Neodermata clade. If monoge- nean monophyly is true, as supported by the majority of previous works, it is expected that a single shifting event from ecto- to endo-parasitism or vice versa is equally pos- sible to explain the evolutionary scenario of the parasitic patterns found in the neodermatan group
