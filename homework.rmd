...
To do: 
pictures do not align in pdf
more clarity in the workflow
N50 values
...
The specimen of *D. coeliaca* were sampled in Norway from the host species *R. radiata*. The samples were collected fresh and instantly stored in 96% ethanol. DNA extraction was done using the Zymo Research DNA Miniprep Plus Kit. The elution step was conducted twice with an incubation time of 10 minutes and 50 µl each. The concentration was assessed with a Qubit 4 Flourometer using the broad range assay resulting in of 69.6 ng/µl. The TapeStation 2200 (Agilent Technologies) was used to assess the size distribution, using genomic DNA Screen Tapes , see fig. Before the library preparation the extracts were cleaned up with AMPure XP beads. \@ref(fig:tapestation). To reach the recommended concentration of 1µg of high molecular weight DNA two sample specimen (20µl B164-65, 21µl B161-63) were pooled for the library preparation. Library preparation was done using the Nanopore Ligation Sequencing Kit (SQK-LSK109). To enrich sequences with a length of 3kb or longer, we used the long frame buffer following the protocol (Lab Protocol Version `GDE_9063_v109_revT_14Aug2019` which is deposited on a github repository: [AMEB 2020 practical](https://github.com/chrishah/AMEB_2020_practical)).
...
In total 313 BUSCO genes were used in the supermatrix to calculate the phylogenetic tree, of which four could be found in all of the taxa, see fig. \@ref(fig:genetree). None of the calculated single gene trees show the Monogenean as a monophyletic group. The resulting phylogenetic tree using the supermatrix with all 313 BUSCO genes can be seen in fig. \@ref(fig:tree). It shows high bootstrap coverage for all nodes except one internal clade node, but this did not influence the phylogenetic position of the groups in question. 
...
The paraphyletic position of the Monopisthocotylea as basal group and the Polyopisthocotylea as sister group to the Trematoda could indicate two separate evolutionary events for the lifestyle in the Neodermata evolutionary history (ecto- vs. endoparasitism). As the Turbellaria, which comprise the non parasitic Plathelminthes besides the parasitic Neodermata, are free living we would expect that ectoparasitic lifestyle is the logical plesiomorphic trait for Neodermata. @park2007 also suggested that ectoparasitism arose first but they only used one taxa to represent the Monogeneans in their study (Polyopisthocotylean, *Microcotyle sebastis*). Another study with more Monopisthocotyleans but only one Polyopisthocotylean taxa (*M. sebastis*) did also come to a similar conclusion, although the resulting tree did show the Polyopisthocotylean as sister group to the monophyletic Trematoda and Cestoda, see fig. \@ref(fig:tapestation)-b) [@perkins2010]. Our results also indicate the Monopistholocotyleans as basal group but suggest a monophyly between the Polyopisthocotylean and the Trematoda. This could indicate a second evolutionary event back from endoparasitism to ectoparasitims. Therefore, the ectoparasitic trait, which is shared by most Monopisthocotyleans and Polyopisthocotyleans, could be homoplastic. Another possible hypothesis is, that the basal trait in the ancestors of Polyopisthocotyleans was never lost as previously proposed [@park2007; @perkins2010].

The same can be inferred for the evolutionary history of the life cycle (complex vs. simple). The majority of taxa in the Monogeneans possess a simple life cycle, whereas the life cycle of trematodes and cestodes is more complex.  Trematodes almost always infect moluscs in their life cycle, while, Cestodes possess one or two intermediate hosts and their eggs are released from intestinally living adults via host faeces [@gibson2014]. The evolutionary history could follow two distinct events from simple to complex and back to a simple life cycle, or the simple life cycle in Polyopisthocotyleans could still represent the ancestral trait. 

The evolution of the feeding habit seems more difficult. Our basal group of Monopisthocotylean feeds mostly on skin and/or mucus [@gibson2014]. This type of feeding could be the ancestral plesiomorphic trait but it also seems plausible that the ancestor already did feed on blood like most Polyopisthocotyleans, while the more sophisticated haptor design could have evolved later [@park2007]. As Trematodes also mostly feed on blood, diet could explain the connection in our monophyletic group and lead back to a shared ancestor, which probably also showed the same feeding habit. The evolutionary speciation between the Polyopisthocotyleans and the Trematodes might have evolved via adaptation to different niches on host species (ecto- and endoparasitic). The split of the Cestoda might have happened earlier in history as previously thought [@littlewood1999; @olson2001; @perkins2010; @laumer2014]. The feeding habit of Cestoda is probably not the ancestral trait as they absorb their nutrients through the surface layer and did loose organs for digestion, e.g. guts [@gibson2014], which probably poses a point of no return, at least in the given time frame. 

Overall, our newly proposed phylogeny should give room for new discussion and shows the need for molecular studies involving multiple species of Monogeneans and the advantages in using a supermatrix of different genes. 
